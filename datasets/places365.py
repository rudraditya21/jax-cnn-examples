...
PLACES365_MEAN = (0.485, 0.456, 0.406)
PLACES365_STD = (0.229, 0.224, 0.225)
...
def _build_transforms(
    ...
    """
    Constructs the training and evaluation transforms for Places365 dataset.
    ...
    if augment:
        train_transform = transforms.Compose(
            [
                ...
                transforms.ToTensor(),
                transforms.Normalize(PLACES365_MEAN, PLACES365_STD),
            ]
        )
    else:
        train_transform = transforms.Compose(
...
@DatasetRegistry.register("places365")
def load_places365(
    data_dir: str = "./data",
    batch_size: int = 64,
    shuffle: bool = True,
    ...
    augment: bool = True,
    image_size: int = 224,
    train_split: str = "train-standard",
    eval_split: str = "val",
    small: bool = False,
) -> tuple[DataLoader, DataLoader, int]:
    """
    Loads the Places365 dataset with standardized transforms and DataLoaders.
    ...
    Args:
        ...
        train_split (str, optional): Dataset split to use for training.
            Defaults to "train-standard".
        eval_split (str, optional): Dataset split to use for evaluation. Defaults to "val".
        small (bool, optional): Whether to use the smaller 256x256 Places365 variant.
            Defaults to False.
    ...
    Returns:
        ...
        A tuple containing:
            ...
            - The number of output classes (365 for Places365)
    """
    ...
    eval_dataset = datasets.Places365(
        root=data_path,
        split=eval_split,
        small=small,
        download=True,
