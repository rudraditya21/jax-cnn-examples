...
OXFORDIIITPET_MEAN = (0.485, 0.456, 0.406)
OXFORDIIITPET_STD = (0.229, 0.224, 0.225)
...
def _build_transforms(
    ...
    """
    Constructs the training and evaluation transforms for OxfordIIITPet dataset.
    ...
    if augment:
        train_transform = transforms.Compose(
            [
                ...
                transforms.ToTensor(),
                transforms.Normalize(OXFORDIIITPET_MEAN, OXFORDIIITPET_STD),
            ]
        )
    else:
        train_transform = transforms.Compose(
...
@DatasetRegistry.register("oxfordiiitpet")
def load_oxfordiiitpet(
    data_dir: str = "./data",
    batch_size: int = 64,
    shuffle: bool = True,
    num_workers: int = 4,
    ...
    """
    Loads the OxfordIIITPet dataset with standardized transforms and DataLoaders.
    ...
    Args:
        ...
        train_split (str, optional): Dataset split to use for training. Defaults to "trainval".
        eval_split (str, optional): Dataset split to use for evaluation. Defaults to "test".
        target_type (str, optional): Target type to use. Defaults to "category".
    ...
    Returns:
        ...
        A tuple containing:
            ...
            - The number of output classes (37 for OxfordIIITPet)
    """
