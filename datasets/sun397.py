...
SUN397_MEAN = (0.485, 0.456, 0.406)
SUN397_STD = (0.229, 0.224, 0.225)
...
def _build_transforms(
    ...
    """
    Constructs the training and evaluation transforms for SUN397 dataset.
    ...
    if augment:
        train_transform = transforms.Compose(
            [
                ...
                transforms.ToTensor(),
                transforms.Normalize(SUN397_MEAN, SUN397_STD),
            ]
        )
    else:
        train_transform = transforms.Compose(
...
@DatasetRegistry.register("sun397")
def load_sun397(
    data_dir: str = "./data",
    batch_size: int = 64,
    shuffle: bool = True,
    ...
    """
    Loads the SUN397 dataset with standardized transforms and DataLoaders.
    ...
    Returns:
        ...
        A tuple containing:
            ...
            - The number of output classes (397 for SUN397)
    """
    data_path = Path(data_dir)
    train_transform, eval_transform = _build_transforms(augment, image_size)

    train_dataset = datasets.SUN397(
        root=data_path,
        split=train_split,
        download=True,
