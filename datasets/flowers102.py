...
def _build_transforms(
    ...
    """
    Constructs the training and evaluation transforms for Flowers102 dataset.
    ...
    if augment:
        train_transform = transforms.Compose(
            [
                ...
                transforms.ToTensor(),
                transforms.Normalize(FLOWERS102_MEAN, FLOWERS102_STD),
            ]
        )
    else:
        train_transform = transforms.Compose(
...
@DatasetRegistry.register("flowers102")
def load_flowers102(
    data_dir: str = "./data",
    batch_size: int = 64,
    shuffle: bool = True,
    ...
    """
    Loads the Flowers102 dataset with standardized transforms and DataLoaders.
    ...
    Returns:
        ...
        A tuple containing:
            ...
            - The number of output classes (102 for Flowers102)
    """
    ...
    eval_dataset = datasets.Flowers102(
        root=data_path,
        split=eval_split,
        download=True,
