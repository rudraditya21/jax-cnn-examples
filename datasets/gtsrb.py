...
GTSRB_MEAN = (0.485, 0.456, 0.406)
GTSRB_STD = (0.229, 0.224, 0.225)
...
def _build_transforms(
    ...
    """
    Constructs the training and evaluation transforms for GTSRB dataset.
...
@DatasetRegistry.register("gtsrb")
def load_gtsrb(
    data_dir: str = "./data",
    batch_size: int = 64,
    shuffle: bool = True,
    ...
    """
    Loads the GTSRB dataset with standardized transforms and DataLoaders.
    ...
    Args:
        ...
        augment (bool, optional): Whether to apply data augmentation to the training set.
            Defaults to True.
        image_size (int, optional): Spatial size to resize images to. Defaults to 32.
    ...
    Returns:
        ...
        A tuple containing:
            ...
            - The number of output classes (43 for GTSRB)
    """
