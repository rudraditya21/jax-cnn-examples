...
def _build_transforms(
    ...
    """
    Constructs the training and evaluation transforms for Food101 dataset.
...
@DatasetRegistry.register("food101")
def load_food101(
    data_dir: str = "./data",
    batch_size: int = 64,
    shuffle: bool = True,
    ...
    """
    Loads the Food101 dataset with standardized transforms and DataLoaders.
    ...
    Returns:
        ...
        A tuple containing:
            ...
            - The number of output classes (101 for Food101)
    """
