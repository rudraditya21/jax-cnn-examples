...
def _build_transforms(augment: bool) -> tuple[transforms.Compose, transforms.Compose]:
    """
    Constructs the training ans evaluation transforms for MNIST dataset.
...
def load_mnist(
    ...
    """
    Loads the MNIST dataset with standardized transforms and DataLoaders.

    The function provides a clean, unified entry point for integrating MNIST into training pipelines. All dataset configuration parameters are exposed as function arguments to support experimentation and reproducibility.
    ...
    Returns:
        ...
        A tuple containing:
            ...
            - The number of output classes (10 for MNIST)
    """
