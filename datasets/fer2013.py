...
def _build_transforms(
    ...
    """
    Constructs the training and evaluation transforms for FER2013 dataset.
    ...
    if augment:
        train_transform = transforms.Compose(
            [
                ...
                transforms.ToTensor(),
                transforms.Normalize(FER2013_MEAN, FER2013_STD),
            ]
        )
    else:
        train_transform = transforms.Compose(
...
@DatasetRegistry.register("fer2013")
def load_fer2013(
    data_dir: str = "./data",
    batch_size: int = 64,
    shuffle: bool = True,
    ...
    """
    Loads the FER2013 dataset with standardized transforms and DataLoaders.
    ...
    Args:
        ...
        augment (bool, optional): Whether to apply data augmentation to the training set.
            Defaults to True.
        image_size (int, optional): Spatial size to resize images to. Defaults to 48.
    ...
    Returns:
        ...
        A tuple containing:
            ...
            - The number of output classes (7 for FER2013)
    """
