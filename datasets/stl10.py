...
def _build_transforms(
    ...
    """
    Constructs the training and evaluation transforms for STL10 dataset.
...
def load_stl10(
    ...
    """
    Loads the STL10 dataset with standardized transforms and DataLoaders.
    ...
    Args:
        ...
        augment (bool, optional): Whether to apply data augmentation to the training set.
            Defaults to True.
        image_size (int, optional): Spatial size to resize/crop images to. Defaults to 96.
    ...
    Returns:
        ...
        A tuple containing:
            ...
            - The number of output classes (10 for STL10)
    """
