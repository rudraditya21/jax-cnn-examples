...
@ModuleRegistry.register("vgg13")
def vgg13(num_classes: int = 1000, dropout_rate: float | None = 0.5):
    """
    VGG-13 configuration (A).
    """
    layers = [
...
@ModuleRegistry.register("vgg13-bn")
def vgg13_bn(num_classes: int = 1000, dropout_rate: float | None = 0.5):
    """
    VGG-13 with BatchNorm.
    """
    layers = [
        stax.Conv(64, (3, 3), padding="SAME"),
        stax.BatchNorm(),
